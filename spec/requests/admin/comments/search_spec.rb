  ...
  describe 'GET /search' do
    context 'when authorized without records' do
      before do
        ...
        get search_admin_comments_url, params: { search_query: 'empty search' }
      end
    ...
    context 'when authorized with records' do
      before do
        ...
        get search_admin_comments_url, params: { search_query: comments.first.title }
      end
    ...
    context 'when authorized with records and wrong search' do
      before do
        ...
        get search_admin_comments_url, params: { search_query: 'wrong search' }
      end
