...
RSpec.describe '/admin/articles/:article_id/reviews' do
  ...
  let(:valid_attributes) { attributes_for(:review, article_id: article.id) }
  ...
  describe 'POST /create' do
    context 'when authorized with valid parameters' do
      ...
      it 'creates a new Review' do
        expect do
          post admin_article_reviews_url(article_id: article.id), params: { review: valid_attributes }
      ...
      it 'redirects to the created review' do
        ...
        expect(response).to redirect_to(admin_review_url(id: Review.last.id))
      end
    ...
    context 'when authorized with invalid parameters' do
      ...
      it 'does not create a new Review' do
        expect do
          post admin_article_reviews_url(article_id: article.id), params: { review: invalid_attributes }
