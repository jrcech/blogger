  ...
  describe 'POST /create' do
    context 'when authorized with valid parameters' do
      ...
      it 'creates a new Technology' do
        expect do
          post admin_article_technologies_url(article_id: article.id), params: { technology: valid_attributes }
    ...
    context 'when authorized with invalid parameters' do
      ...
      it 'does not create a new Technology' do
        expect do
          post admin_article_technologies_url(article_id: article.id), params: { technology: invalid_attributes }
